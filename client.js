...
function validateToken() {
    ...
    let validateTokenLink = document.getElementById("validate-link");
...
function getFilesPermission() {
    ...
    let getFilesPermissionLink = document.getElementById("getfilespermission-link");
...
function revokeToken() {
    ...
    let revokeTokenLink = document.getElementById("revoketoken-link");
